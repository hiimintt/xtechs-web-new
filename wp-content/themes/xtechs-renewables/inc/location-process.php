...
/**
 * Process steps + panel copy (mirrors xtechs-website src/components/ui/process-steps.tsx).
 *
 * @return array{steps: list<array{id: string, label: string}>, content: array<string, array{title: string, description: string, body: string}>}
 */
function xtechs_location_process_data(): array
{
    return [
        'steps' => [
