<?php
/**
 * Home page copy aligned with xtechs-website (Next.js) sources.
 */
if (!defined('ABSPATH')) {
    exit;
}
...
/**
 * @return array<string, array{title: string, description: string, body: string}>
 */
function xtechs_home_process_content(): array {
    return [
        'consultation' => [
 ...
 */
function xtechs_home_static_reviews(): array {
    return [
        [
            'author_name' => 'Victorian Homeowner',
            'source'      => 'Google Review',
            'text'        => 'Professional team from consultation through to handover. Clear communication and a system that performs exactly as designed.',
            'date_label'  => '',
        ],
        [
